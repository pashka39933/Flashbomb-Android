...
public class ObservationsTabRecyclerViewAdapter extends RecyclerView.Adapter<ObservationsTabRecyclerViewAdapter.ViewHolder> {
    ...
    /* Constructor */
    public ObservationsTabRecyclerViewAdapter(MainActivity activity, ArrayList<FlashbombEntity> imageUrls, int itemHeight) {
        ...
        activity.SetObservationsListAdapter(this);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            /* Finding views */
            video = itemView.findViewById(R.id.observationsItemPreviewVideo);
            image = itemView.findViewById(R.id.observationsItemPreviewImage);
            preloadProgressBar = itemView.findViewById(R.id.observationsItemPreviewProgressBar);
            nick = itemView.findViewById(R.id.observationsItemNick);
            emoji = itemView.findViewById(R.id.observationsItemEmoji);
            reportButton = itemView.findViewById(R.id.observationsItemReport);
            likeButton = itemView.findViewById(R.id.observationsItemLike);
            soundAnimation = itemView.findViewById(R.id.observationsItemSound);

        }
    }

    @Override
    public ObservationsTabRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.observations_listview_item, parent, false);
        return new ObservationsTabRecyclerViewAdapter.ViewHolder(v);

    }

    @Override
    public void onBindViewHolder(final ObservationsTabRecyclerViewAdapter.ViewHolder holder, final int position) {
