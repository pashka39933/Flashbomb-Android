...
public class PanoramaGyroscopeListener implements SensorEventListener {
    ...
    private double mMaxRotateRadian = Math.PI/1;
    ...
    public void register(Context context) {
        ...
        if(!sharedPref.getBoolean(context.getString(R.string.PREFERENCES_IMAGE_EFFECTS_ACTIVE), false)) {
            unregister();
            return;
        }
